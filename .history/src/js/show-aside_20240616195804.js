...
const FEEDBACK_ICON = document.querySelector('#burger-menu')
const FEEDBACK_CROSS_ICON = document.querySelector('#burger-menu')
const FEEDBACK_MENU = document.querySelector('#burger-menu')

const CALL_ICON = document.querySelector('#burger-menu')
const CALL_CROSS_ICON = document.querySelector('#burger-menu')
const CALL_MENU = document.querySelector('#burger-menu')
